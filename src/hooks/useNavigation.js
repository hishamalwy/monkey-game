...
export function useNavigation() {
  ...
  return {
    ...
    toBuzzerHost: (code) => navigate(`/buzzer/${code || roomCode}`),
    toBuzzerPlayer: (code) => navigate(`/buzzer-play/${code || roomCode}`),
    toBuzzerGameOver: (code) => navigate(`/buzzer-over/${code || roomCode}`, { replace: true }),
